...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    public void onPinCompleted()
    {
        try // TRY LOGIN MECHANICS
        {
            ...
            {
                Toast.makeText(LoginActivity.this, "Wrong code, please retry", Toast.LENGTH_SHORT).show(); // DISPLAY THE REJECT MESSAGE
            }
        } catch (Exception e)
        {
            e.printStackTrace();
            Toast.makeText(LoginActivity.this, "Wrong code, please retry", Toast.LENGTH_SHORT).show(); // SOMETHING WENT WRONG WITH DATA COMPARISONS
        }
