...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void onPasscodeCompleted() {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                final String passcodeHashAndEncrypted; // GENERATE THE HASH passcode
                try {
                    ...
                    String pinHash = SHA256PinHash.HASH_FUNCTION(passcode, SHA256PinHash.GENERATE_SALT());
                    passcodeHashAndEncrypted = keyHandler.ENCRYPT_KEY(pinHash, passcode);
