...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isRegistered()) {
            ACTIVITY_INTENT = new Intent(this, RegisterActivity.class);
            this.finish();
    ...
    */
    private void loginIntent() {
        ...
        if (bundle != null && bundle.getBoolean("edit?", false)) {
            ...
            intent = new Intent(LoginActivity.this, NoteListActivity.class);
        }

        this.finish();
        LoginActivity.this.startActivity(intent); // MOVE TO MAIN ACTIVITY
    }
