...
import com.gerardogandeaga.cyberlock.core.dialogs.TagsFragmentDialog;
...
// todo break into 3 fragments
public class EditActivity extends AppCompatActivity implements View.OnClickListener, TagsFragmentDialog.OnColourSelected {
    @Override
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        ...
        if (bundle != null) {
            ...
            if (!mIsNew) {
                ...
                switch (mNoteObject.getType()) {
                    ...
                    case NoteObject.CARD: setupLayoutPaymentInfo(); this.enum_type = Type.PAYMENT_INFO; break;
                    case NoteObject.LOGIN:   setupLayoutLoginInfo();   this.enum_type = Type.LOGIN_INFO; break;
                }
    ...
    private void setupLayoutNote() {
        this.mView = View.inflate(this, R.layout.fragment_edit_note, null);
        setContentView(mView);
        setupSupportActionBar(); // Action bar

        // widgets
        setupMainWidgets();
        this.mEtNote = findViewById(R.id.etNotes);

        setupDataNote();
    }
    private void setupLayoutPaymentInfo() {
        this.mView = View.inflate(this, R.layout.fragment_edit_card, null);
        setContentView(mView);
        setupSupportActionBar(); // action bar
        ...
        this.mEtCardCVV = findViewById(R.id.etCardCVV);
    ...
    private void setupLayoutLoginInfo() {
        this.mView = View.inflate(this, R.layout.fragment_edit_login, null);
        setContentView(mView);
        setupSupportActionBar(); // action bar
    ...
    private void setupDataNote() {
        if (mIsNew) {
            ...
            // set note
            mEtNote.setText(mNoteContentHandler.mNotes);
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imgTag: TagsFragmentDialog.show(this); break;
        }
    }
