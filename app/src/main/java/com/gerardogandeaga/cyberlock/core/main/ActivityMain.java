...
import com.gerardogandeaga.cyberlock.core.dialogs.DialogDataPreview;
...
import com.gerardogandeaga.cyberlock.lists.handlers.extractors.NoteItemContentHandler;
import com.gerardogandeaga.cyberlock.lists.handlers.selection.AdapterActionHandler;
import com.gerardogandeaga.cyberlock.lists.handlers.selection.actions.DataObjectDeleter;
import com.gerardogandeaga.cyberlock.lists.recyclerview.decorations.NoteItemDecoration;
...
//        if (this.mDrawerToggle.onOptionsItemSelected(item)) return true;
    ...
    public void onAddClicked(String TYPE) {
        ACTIVITY_INTENT = new Intent(this, TempEdit.class);
